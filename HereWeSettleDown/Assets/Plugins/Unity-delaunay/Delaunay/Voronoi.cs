...
namespace Delaunay
{
	public sealed class Voronoi: Utils.IDisposable
	{
        ...
        private System.Random weightDistributor;
...
//			_plotBounds = null;
		...
		public Voronoi (List<Vector2> points, List<uint> colors, Rect plotBounds, System.Random prng)
		{
            weightDistributor = prng;
		...
		private void AddSite (Vector2 p, uint color, int index)
		{
			...
			float weight = (float)weightDistributor.NextDouble() * 100f;
